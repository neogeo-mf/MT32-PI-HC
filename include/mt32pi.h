...
extern volatile bool g_bManualSleepMode;
class CMT32Pi : CMultiCoreSupport, public CPower, public CMIDIParser, public CAppleMIDIHandler, public CUDPMIDIHandler
{
public:
...
private:
	...
	bool m_bShowSleepAnimation = false;
